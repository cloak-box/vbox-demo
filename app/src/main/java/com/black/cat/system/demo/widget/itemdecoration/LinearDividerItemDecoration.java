...
/**
 * z This class can only be used in the RecyclerView which use a LinearLayoutManager or its
 * subclass.
 */
public class LinearDividerItemDecoration extends RecyclerView.ItemDecoration {
  ...
  public void getItemOffsets(
    ...
    if (mDividerOffsets.indexOfKey(adapterPosition) < 0) {
      mDividerOffsets.put(
          adapterPosition, getDivider(parent, adapterPosition).getIntrinsicHeight());
    }
  ...
  @IntDef({LINEAR_DIVIDER_HORIZONTAL, LINEAR_DIVIDER_VERTICAL})
