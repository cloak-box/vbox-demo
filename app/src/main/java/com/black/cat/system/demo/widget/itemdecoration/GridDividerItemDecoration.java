...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
  ...
  public void getItemOffsets(
    ...
    if (mHorizontalDividerOffsets.indexOfKey(adapterPosition) < 0) {
      mHorizontalDividerOffsets.put(
          adapterPosition, getHorizontalDivider(parent, adapterPosition).getIntrinsicHeight());
    }

    if (mVerticalDividerOffsets.indexOfKey(adapterPosition) < 0) {
      mVerticalDividerOffsets.put(
          adapterPosition, getVerticalDivider(parent, adapterPosition).getIntrinsicHeight());
    }

    outRect.set(
        0,
        0,
        mHorizontalDividerOffsets.get(adapterPosition),
        mVerticalDividerOffsets.get(adapterPosition));
