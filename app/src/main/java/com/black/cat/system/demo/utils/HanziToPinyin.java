 ...
 * ICU.
 *
 * <p>Currently this file is aligned to zh.txt in ICU 4.6
 */
public class HanziToPinyin {
   ...
   * Unihans array.
   *
   * <p>Each unihans is the first one within same pinyin when collator is zh_CN.
   */
   ...
   * Pinyin array.
   *
   * <p>Each pinyin is corresponding to unihans of same offset in the unihans array.
   */
  ...
  public String getSpelling(final String input) {
