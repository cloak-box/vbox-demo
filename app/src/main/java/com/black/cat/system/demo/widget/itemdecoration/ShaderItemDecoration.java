package com.black.cat.system.demo.widget.itemdecoration;
...
public class ShaderItemDecoration extends RecyclerView.ItemDecoration {
  ...
  @ShaderType private final int mShaderType;
  ...
  private void initShaderItemDecoration(Context context) {
    mShaderTopDistance =
        (int)
            TypedValue.applyDimension(
                ...
                DEFAULT_SHADER_VERTICAL_DISTANCE_DP,
    ...
    mShaderLeftDistance =
        (int)
            TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP,
                DEFAULT_SHADER_HORIZONTAL_DISTANCE_DP,
                context.getResources().getDisplayMetrics());
  ...
  private void drawBottomShader(Canvas c, RecyclerView parent) {
    ...
    c.drawRect(
        0,
        parent.getHeight() - mShaderBottomDistance,
        parent.getWidth(),
        parent.getHeight(),
        paint);
  }
  ...
  private void drawRightShader(Canvas c, RecyclerView parent) {
    ...
    c.drawRect(
        parent.getWidth() - mShaderRightDistance, 0, parent.getWidth(), parent.getHeight(), paint);
  }
      ...
      if (mRightShaderCreator != null) {
        ...
        mRightShader =
            new LinearGradient(
                parent.getWidth(),
                0,
                parent.getWidth() - mShaderRightDistance,
                0,
                SHADER_START_COLOR,
                SHADER_END_COLOR,
                Shader.TileMode.CLAMP);
  ...
  @IntDef(
      value = {SHADER_BOTTOM, SHADER_TOP, SHADER_LEFT, SHADER_RIGHT},
      flag = true)
