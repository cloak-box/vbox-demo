...
public class WaveSideBarView extends View {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    int mWaveColor = Color.parseColor("#be69be91");
    ...
    if (attrs != null) {
      ...
      mTextColor = a.getColor(R.styleable.WaveSideBarView_sidebar_text_color, mTextColor);
      mTextColorChoose =
          a.getColor(R.styleable.WaveSideBarView_sidebar_choosetext_color, mTextColorChoose);
      mTextSize = a.getFloat(R.styleable.WaveSideBarView_sidebar_text_size, mTextSize);
      mLargeTextSize =
          a.getFloat(R.styleable.WaveSideBarView_sidebar_large_text_size, mLargeTextSize);
      mWaveColor = a.getColor(R.styleable.WaveSideBarView_sidebar_background_color, mWaveColor);
      mRadius =
          a.getDimensionPixelSize(
              R.styleable.WaveSideBarView_sidebar_radius,
              context.getResources().getDimensionPixelSize(R.dimen.radius_sidebar));
      mBallRadius =
          a.getDimensionPixelSize(
              R.styleable.WaveSideBarView_sidebar_ball_radius,
              context.getResources().getDimensionPixelSize(R.dimen.ball_radius_sidebar));
      a.recycle();
    }
  ...
  public boolean dispatchTouchEvent(MotionEvent event) {
    ...
    oldChoose = mChoose;
    newChoose = (int) (y / mHeight * mLetters.length);
    ...
    switch (event.getAction()) {
      ...
      case MotionEvent.ACTION_MOVE:
        ...
        if (oldChoose != newChoose) {
          if (newChoose >= 0 && newChoose < mLetters.length) {
            mChoose = newChoose;
            if (listener != null) {
  ...
  private void drawChooseText(Canvas canvas) {
    if (mChoose != -1) {
      ...
      // 绘制提示字符
      if (mRatio >= 0.9f) {
        String target = mLetters[mChoose];
