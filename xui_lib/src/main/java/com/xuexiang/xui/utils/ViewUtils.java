...
public final class ViewUtils {
  ...
  public static void setBackgroundKeepingPadding(View view, int backgroundResId) {
    setBackgroundKeepingPadding(
        view, ContextCompat.getDrawable(view.getContext(), backgroundResId));
  }
   ...
   */
  public static Animator playViewBackgroundAnimation(
      final View v,
  ...
  public static void playViewBackgroundAnimation(
      final View v, @ColorInt int bgColor, int[] alphaArray, int stepDuration) {
  ...
  public static void playViewBackgroundAnimation(
      final View v, int startColor, int endColor, long duration) {
   ...
   * 对 View 做透明度变化的进场动画。
   *
   * <p>相关方法 {@link #fadeOut(View, int, Animation.AnimationListener, boolean)}
   *
  ...
  public static AlphaAnimation fadeIn(
      View view, int duration, Animation.AnimationListener listener) {
   ...
   */
  public static AlphaAnimation fadeIn(
      View view, int duration, Animation.AnimationListener listener, boolean isNeedAnimation) {
    if (view == null) {
      return null;
    }
    if (isNeedAnimation) {
   ...
   * 对 View 做透明度变化的退场动画
   *
   * <p>相关方法 {@link #fadeIn(View, int, Animation.AnimationListener, boolean)}
   *
   * @param view 做动画的 View
   * @param duration 动画时长(毫秒)
   * @param listener 动画回调
  ...
  public static AlphaAnimation fadeOut(
      final View view, int duration, final Animation.AnimationListener listener) {
   ...
   * 对 View 做上下位移的进场动画
   *
   * <p>相关方法 {@link #slideOut(View, int, Animation.AnimationListener, boolean, Direction)}
   *
   * @param view 做动画的 View
   * @param duration 动画时长(毫秒)
   * @param listener 动画回调
   ...
   * 对 View 做上下位移的退场动画
   *
   * <p>相关方法 {@link #slideIn(View, int, Animation.AnimationListener, boolean, Direction)}
   *
   * @param view 做动画的 View
   * @param duration 动画时长(毫秒)
   * @param listener 动画回调
  ...
  public static void setOnCheckedChangeListener(
      CompoundButton view, CompoundButton.OnCheckedChangeListener checkedChangeListener) {
    if (view != null) {
   ...
   * @param checkedChangeListener 选中监听
   */
  public static void setCheckedSilent(
      CompoundButton view,
      boolean isCheck,
  ...
  public static void setPaddingStart(View view, int value) {
    if (value != view.getPaddingStart()) {
      view.setPaddingRelative(
          value, view.getPaddingTop(), view.getPaddingEnd(), view.getPaddingBottom());
    }
  }
  ...
  public static void setPaddingTop(View view, int value) {
    if (value != view.getPaddingTop()) {
      view.setPadding(
          view.getPaddingLeft(), value, view.getPaddingRight(), view.getPaddingBottom());
    }
  }
  ...
  public static void setPaddingEnd(View view, int value) {
    if (value != view.getPaddingEnd()) {
      view.setPaddingRelative(
          view.getPaddingStart(), view.getPaddingTop(), value, view.getPaddingBottom());
    }
  }
  ...
  /**
   * 判断是否需要对 LineSpacingExtra 进行额外的兼容处理 安卓 5.0 以下版本中，LineSpacingExtra 在最后一行也会产生作用，因此会多出一个
   * LineSpacingExtra 的空白，可以通过该方法判断后进行兼容处理 if (ViewUtils.getISLastLineSpacingExtraError()) {
   * textView.bottomMargin = -3dp; } else { textView.bottomMargin = 0; }
   */
  ...
  public static View findViewFromViewStub(
      View parentView, int viewStubId, int inflatedViewId, int inflateLayoutResId) {
    if (null == parentView) {
      return null;
    }
    View view = parentView.findViewById(inflatedViewId);
  ...
  public static void safeSetImageViewSelected(ImageView imageView, boolean selected) {
    ...
    if (drawable.getIntrinsicWidth() != drawableWidth
   ...
   * @param typeface 字体
   */
  public static void setToolbarLayoutTextFont(
      CollapsingToolbarLayout collapsingToolbarLayout, Typeface typeface) {
