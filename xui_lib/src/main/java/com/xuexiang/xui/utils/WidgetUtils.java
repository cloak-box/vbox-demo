...
public final class WidgetUtils {
  ...
  public static void initSpinnerStyle(@NonNull Spinner spinner) {
    ...
    spinner.setBackground(
        ResUtils.getDrawable(spinner.getContext(), R.drawable.xui_config_bg_spinner));
    ViewUtils.setPaddingEnd(
        spinner,
        ResUtils.getDimensionPixelSize(
            spinner.getContext(), R.dimen.default_spinner_icon_padding_size));
    // 下拉选择菜单的背景
    spinner.setPopupBackgroundDrawable(
        ResUtils.getDrawable(spinner.getContext(), R.drawable.ms_drop_down_bg_radius));
  ...
  public static void initSpinnerItem(@NonNull Spinner spinner, @NonNull String[] items) {
    ArrayAdapter<String> adapter =
        new ArrayAdapter<>(
            spinner.getContext(),
            R.layout.xui_layout_spinner_selected_item,
            R.id.spinner_item,
            items);
  ...
  public static void setSpinnerDropDownVerticalOffset(@NonNull Spinner spinner) {
    ...
    int dropdownOffset =
        ThemeUtils.resolveDimension(spinner.getContext(), R.attr.ms_dropdown_offset);
   ...
   * @param resId 选项图标
   */
  public static TabLayout.Tab addTabWithoutRipple(
      @NonNull TabLayout tabLayout, @Nullable CharSequence text, @DrawableRes int resId) {
   ...
   */
  public static TabLayout.Tab addTabWithoutRipple(
      @NonNull TabLayout tabLayout, @Nullable CharSequence text, @Nullable Drawable icon) {
    TabLayout.Tab tab = tabLayout.newTab();
    tab.setText(text);
    tab.setIcon(icon);
    tab.view.setBackgroundColor(Color.TRANSPARENT);
  ...
  public static void initGridRecyclerView(@NonNull RecyclerView recyclerView, int spanCount) {
    ...
    recyclerView.addItemDecoration(
        new GridDividerItemDecoration(recyclerView.getContext(), spanCount));
   ...
   */
  public static void initGridRecyclerView(
      @NonNull RecyclerView recyclerView, int spanCount, int dividerWidth) {
    recyclerView.setLayoutManager(new XGridLayoutManager(recyclerView.getContext(), spanCount));
    recyclerView.addItemDecoration(
        new GridDividerItemDecoration(recyclerView.getContext(), spanCount, dividerWidth));
    recyclerView.setItemAnimator(new DefaultItemAnimator());
  }
   ...
   */
  public static void initGridRecyclerView(
      @NonNull RecyclerView recyclerView, int spanCount, int dividerWidth, int dividerColor) {
    recyclerView.setLayoutManager(new XGridLayoutManager(recyclerView.getContext(), spanCount));
    recyclerView.addItemDecoration(
        new GridDividerItemDecoration(
            recyclerView.getContext(), spanCount, dividerWidth, dividerColor));
    recyclerView.setItemAnimator(new DefaultItemAnimator());
  }
  ...
  public static void initGridRecyclerView(
    ...
    recyclerView.setLayoutManager(
        new XGridLayoutManager(recyclerView.getContext(), spanCount).setScrollEnabled(canScroll));
    recyclerView.addItemDecoration(
        new GridDividerItemDecoration(
            recyclerView.getContext(), spanCount, dividerWidth, dividerColor));
    recyclerView.setItemAnimator(new DefaultItemAnimator());
  ...
  public static void initRecyclerView(@NonNull RecyclerView recyclerView, int dividerHeight) {
    recyclerView.setLayoutManager(new XLinearLayoutManager(recyclerView.getContext()));
    recyclerView.addItemDecoration(
        new DividerItemDecoration(recyclerView.getContext(), VERTICAL, dividerHeight));
    recyclerView.setItemAnimator(new DefaultItemAnimator());
  }
  ...
  public static void initRecyclerView(
      @NonNull RecyclerView recyclerView, int dividerHeight, int dividerColor) {
    recyclerView.setLayoutManager(new XLinearLayoutManager(recyclerView.getContext()));
    recyclerView.addItemDecoration(
        new DividerItemDecoration(
            recyclerView.getContext(), VERTICAL, dividerHeight, dividerColor));
    recyclerView.setItemAnimator(new DefaultItemAnimator());
  }
   ...
   */
  public static void initRecyclerView(
      @NonNull RecyclerView recyclerView, boolean canScroll, int dividerHeight, int dividerColor) {
    recyclerView.setLayoutManager(
        new XLinearLayoutManager(recyclerView.getContext()).setScrollEnabled(canScroll));
    recyclerView.addItemDecoration(
        new DividerItemDecoration(
            recyclerView.getContext(), VERTICAL, dividerHeight, dividerColor));
    recyclerView.setItemAnimator(new DefaultItemAnimator());
   ...
   * @return loading加载框
   */
  public static LoadingDialog updateLoadingMessage(
      LoadingDialog loadingDialog, @NonNull Context context, @NonNull String message) {
   ...
   * @return MiniLoadingDialog加载框
   */
  public static MiniLoadingDialog getMiniLoadingDialog(
   ...
   *
   * <p>【注意】需要在activity的super.onCreate(savedInstanceState)方法之前调用
   *
   * @param activity 活动页
   */
   ...
   */
  public static void installLayoutInflaterLogger(
      @NonNull final AppCompatActivity activity,
      @NonNull final String loggerTag,
      final long limitCost) {
