...
public class ReadMoreTextView extends AppCompatTextView {
  ...
  private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    trimLength =
        typedArray.getInt(R.styleable.ReadMoreTextView_rmtv_trimLength, DEFAULT_TRIM_LENGTH);
    ...
    colorClickableText =
        typedArray.getColor(
            R.styleable.ReadMoreTextView_rmtv_colorClickableText,
            ThemeUtils.resolveColor(context, androidx.appcompat.R.attr.colorAccent));
    showTrimExpandedText =
        typedArray.getBoolean(
            R.styleable.ReadMoreTextView_rmtv_showTrimExpandedText,
  ...
  private CharSequence updateCollapsedText() {
    ...
    SpannableStringBuilder s =
        new SpannableStringBuilder(text, 0, trimEndIndex)
  ...
  private CharSequence addClickableSpan(SpannableStringBuilder s, CharSequence trimText) {
    s.setSpan(
        viewMoreSpan, s.length() - trimText.length(), s.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    return s;
  }
