    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1) {
      ...
      Drawable radioDrawable =
          ContextCompat.getDrawable(
              radioButton.getContext(), androidx.appcompat.R.drawable.abc_btn_radio_material);
        ...
        new ColorStateList(
            ...
            new int[] {
              ThemeUtils.resolveColor(
                  radioButton.getContext(), androidx.appcompat.R.attr.colorControlNormal),
              color,
              disabledColor,
              disabledColor
            });
  ...
  public static void setTint(@NonNull CheckBox box, @NonNull ColorStateList colors) {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1) {
      ...
      Drawable checkDrawable =
          ContextCompat.getDrawable(
              box.getContext(), androidx.appcompat.R.drawable.abc_btn_check_material);
  ...
  public static void setTint(@NonNull CheckBox box, @ColorInt int color) {
    ...
    ColorStateList sl =
        new ColorStateList(
            ...
            new int[] {
              ThemeUtils.resolveColor(
                  box.getContext(), androidx.appcompat.R.attr.colorControlNormal),
              color,
              disabledColor,
              disabledColor
            });
