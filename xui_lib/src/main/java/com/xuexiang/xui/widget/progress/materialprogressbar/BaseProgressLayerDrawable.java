...
class BaseProgressLayerDrawable<
        ProgressDrawableType extends
            IntrinsicPaddingDrawable & ShowBackgroundDrawable & TintableDrawable,
        BackgroundDrawableType extends
            IntrinsicPaddingDrawable & ShowBackgroundDrawable & TintableDrawable>
  ...
  public BaseProgressLayerDrawable(Drawable[] layers, Context context) {
    ...
    int controlActivatedColor =
        ThemeUtils.getColorFromAttrRes(
            androidx.appcompat.R.attr.colorControlActivated, Color.BLACK, context);
    ...
    if (tint != null) {
      if (!tint.isOpaque()) {
        Log.w(
            ...
            "setTintList() called with a non-opaque"
