...
public class GuideCaseView extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener {
  ...
  private OnClickListener mFocusClickListener;
  ...
  public GuideCaseView(Builder builder) {
    this(
        ...
        builder.mId,
        builder.mTitle,
        builder.mSpannedTitle,
        builder.mTitleGravity,
        builder.mTitleStyle,
        builder.mTitleSize,
        builder.mTitleSizeUnit,
        builder.mFocusCircleRadiusFactor,
        builder.mBackgroundColor,
        builder.mFocusBorderColor,
        builder.mFocusBorderSize,
        builder.mCustomViewRes,
        builder.mViewInflateListener,
        builder.mEnterAnimation,
        builder.mExitAnimation,
        builder.mCloseOnTouch,
        builder.mFitSystemWindows,
        builder.mAdjustHeight,
        builder.mFocusOffSetX,
        builder.mFocusShape,
        builder.mDismissListener,
        builder.mRoundRectRadius,
        builder.mPictureResId,
        builder.mPictureWidth,
        builder.mPictureHeight,
        builder.mPictureGravity,
        builder.mPictureOffSetX,
        builder.mPictureOffSetY,
        builder.mFocusPositionX,
        builder.mFocusPositionY,
        builder.mFocusCircleRadius,
        builder.mFocusRectangleWidth,
        builder.mFocusRectangleHeight,
        builder.mFocusAnimationEnabled,
        builder.mFocusAnimationMaxValue,
        builder.mFocusAnimationStep,
        builder.focusClickListener);
  }
  ...
  private GuideCaseView(
      ...
      int titleSize,
      int titleSizeUnit,
      double focusCircleRadiusFactor,
      int backgroundColor,
      int focusBorderColor,
      int focusBorderSize,
      int customViewRes,
      OnViewInflateListener viewInflateListener,
      ...
      int focusPositionX,
      int focusPositionY,
      int focusCircleRadius,
      int focusRectangleWidth,
      int focusRectangleHeight,
      final boolean animationEnabled,
      int focusAnimationMaxValue,
      int focusAnimationStep,
      OnClickListener focusClickListener) {
    super(activity);
    mId = id;
    mActivity = activity;
    mView = view;
    ...
    mFocusClickListener = focusClickListener;
  ...
  private void focus() {
    ...
    if (visibleView == null) {
      ...
      if (mFocusRectangleWidth > 0 && mFocusRectangleHeight > 0) {
        mCalculator.setRectPosition(
            mFocusPositionX, mFocusPositionY, mFocusRectangleWidth, mFocusRectangleHeight);
      }
      ...
      if (mCloseOnTouch && mFocusClickListener != null) {
        imageView.setOnClickListener(
            new OnClickListener() {
              @Override
              public void onClick(View v) {
                hide();
                mFocusClickListener.onClick(v);
              }
            });
      }
      addView(imageView);
        ...
        .addOnPreDrawListener(
            new ViewTreeObserver.OnPreDrawListener() {
              ...
              public boolean onPreDraw() {
                ...
                } else if (mFocusCircleRadius > 0
                    || mFocusRectangleWidth > 0
                    || mFocusRectangleHeight > 0) {
                  mCenterX = mFocusPositionX;
                  mCenterY = mFocusPositionY;
                }
                Animator enterAnimator =
                    ViewAnimationUtils.createCircularReveal(
                        GuideCaseView.this, mCenterX, mCenterY, startRadius, revealRadius);
                enterAnimator.setDuration(mAnimationDuration);
                enterAnimator.setInterpolator(
                    AnimationUtils.loadInterpolator(
                        mActivity, android.R.interpolator.accelerate_cubic));
                enterAnimator.start();
                return false;
              }
            });
  ...
  private void doCircularExitAnimation() {
    ...
    Animator exitAnimator =
        ViewAnimationUtils.createCircularReveal(this, mCenterX, mCenterY, revealRadius, 0f);
    exitAnimator.setDuration(mAnimationDuration);
    exitAnimator.setInterpolator(
        AnimationUtils.loadInterpolator(mActivity, android.R.interpolator.decelerate_cubic));
  ...
  public static class Builder {
    ...
    private OnClickListener focusClickListener;
    /**
     ...
     * @return Builder
     */
    public Builder customView(
        @LayoutRes int layoutResource, @Nullable OnViewInflateListener listener) {
     ...
     * 设置退出动画
     *
     * <p>【设置推出动画的时候，请一定注意设置动画监听setAnimationListener，并在onAnimationEnd执行GuideCaseView的removeView}方法】
     *
     * @param exitAnimation exit animation for GuideCaseView
     * @return Builder
     */
    ...
    /**
     * Focus round rectangle at specific position 自定义聚焦的矩形区域
     *
     ...
     * @return Builder
     */
    public Builder focusRectAtPosition(
        int positionX, int positionY, int positionWidth, int positionHeight) {
    ...
    /**
     * Focus circle at specific position 自定义聚焦的环形区域
     *
     * @param positionX focus at specific position Y coordinate
     * @param positionY focus at specific position circle radius
    ...
    public Builder setFocusClickListener(OnClickListener focusClickListener) {
