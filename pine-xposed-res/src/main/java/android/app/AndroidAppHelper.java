...
import v.android.app.ActivityThreadKt;
...
public final class AndroidAppHelper {
  ...
  public static void addActiveResource(String resDir, Resources resources) {
    Object thread = ActivityThreadKt.currentActivityThread();
    if (thread == null) {
      return;
    }
  ...
  public static String currentProcessName() {
    String processName = ActivityThreadKt.currentPackageName();
  ...
  public static ApplicationInfo currentApplicationInfo() {
    Object am = ActivityThreadKt.currentActivityThread();
  ...
  public static Application currentApplication() {
    return ActivityThreadKt.currentApplication();
  }
